...
- Individual CLA: `cla/v1.md`
- Current scope: individual contributors submitting documentation or code to RustFS projects
- Current status: initial version stored in this repository

## Repository Layout

- `cla/v1.md`: RustFS Individual Contributor License Agreement, version 1
...
- Add future revisions as new files, for example `cla/v2.md`
